        ...
        if ( levelOne.goalReached() ){
            if ( levelTwo.goalReached() ) {
                if ( levelThree.goalReached() ) {
                    score = levelThree.getPoints() + levelTwo.getPoints() + levelOne.getPoints();
                }
                else score = levelTwo.getPoints() + levelOne.getPoints();
            }
