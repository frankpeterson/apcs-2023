...
public class CombinedTable {
    ...
    public double getDesireability(){
        if ( a.getHeight() == b.getHeight() ){
            return (a.getViewQuality() + b.getViewQuality() )/2.0;
        }
        else return (a.getViewQuality() + b.getViewQuality() )/2.0 - 10;
    }

    public boolean canSeat(int c){
        if ( c <= (a.getNumSeats()+b.getNumSeats()-2)){
            return true;
        }
        return false;
    }
    ...
    public static void main(String[] args) {
        ...
        check(c2.canSeat(18));
        System.out.println((c2.getDesireability() == 62.5));
